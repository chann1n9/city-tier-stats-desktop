...
```json
{
  ...
  "downloads": {
    "mac_arm64": "https://downloads.eastun.tech/city-tier-stats/releases/v{version}/City%20Tier%20Stats-Mac-{version}.dmg",
    "win_x64": "https://downloads.eastun.tech/city-tier-stats/releases/v{version}/City%20Tier%20Stats-Windows-{version}-Setup.exe"
  },
...
- `downloads.mac_arm64` 和 `downloads.win_x64` 必须使用上面示例中的 OSS URL 前缀 `https://downloads.eastun.tech/city-tier-stats/releases/`
